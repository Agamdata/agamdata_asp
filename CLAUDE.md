...
## Current State
- Migration head: `0022` (neutral_rule3_count_not_prompt_enforced — OPS-003 final)
- Applied chain: 0001 → 0002 → 0003 → 0004 → 0005 → 0012 → 0013 → 0014 → 0015 → 0016 → 0017 → 0018 → 0019 → 0020 → 0021 → 0022
