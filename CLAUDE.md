...
## Current State
- Migration head: `0025` (seed_suggest_screen_mapping_prompt — PAP-ASP-REQ-ASP-01 v2.0 / BP-10)
- Applied chain: 0001 → 0002 → 0003 → 0004 → 0005 → 0012 → 0013 → 0014 → 0015 → 0016 → 0017 → 0018 → 0019 → 0020 → 0021 → 0022 → 0023 → 0024 → 0025
