...
## Current State
- Migration head: `0027` (seed_f0302_nlp_prompt — F-03-02 / PAP-ASP-REQ-ASP-02 v1.0)
- Applied chain: 0001 → 0002 → 0003 → 0004 → 0005 → 0012 → 0013 → 0014 → 0015 → 0016 → 0017 → 0018 → 0019 → 0020 → 0021 → 0022 → 0023 → 0024 → 0025 → 0026 → 0027
